...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_IVYSAUR]     = 1,
    [SPECIES_VENUSAUR]    = 1,
    [SPECIES_CHARMANDER]  = 0,  // Prata — palette 0 replaced with custom car palette
    [SPECIES_CHARMELEON]  = 1,  // Prata Pro — palette 1 replaced with custom car palette
    [SPECIES_CHARIZARD]   = 0,
    [SPECIES_SQUIRTLE]    = 2,  // Frankson — palette 2 replaced with custom MJ palette
    [SPECIES_WARTORTLE]   = 2,
    [SPECIES_BLASTOISE]   = 2,
    [SPECIES_CATERPIE]    = 1,
    [SPECIES_METAPOD]     = 1,
