...
struct NamingScreenData
{
    ...
    /*0x1800*/ u8 textBuffer[CODEX_INPUT_LENGTH + 1];
...
static void NamingScreen_Init(void)
{
    ...
    if (sNamingScreen->templateNum == NAMING_SCREEN_CODEX)
...
static const u8 sText_AskCodex[] = _("ASK GPT5.5");
